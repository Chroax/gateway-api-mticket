package com.binar.apigateway.filter;

import com.binar.apigateway.dto.ValidateTokenResponse;
import com.binar.apigateway.utility.Constants;
...
public class AuthenticationPreFilter extends AbstractGatewayFilterFactory<AuthenticationPreFilter.Config> {
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            String bearerToken = serverHttpRequest.getHeaders().getFirst(Constants.HEADER);
            ...
            return webClientBuilder.build().get()
                    ...
                    .header(Constants.HEADER, bearerToken)
